...
// .wrangler/tmp/bundle-zQClsm/checked-fetch.js
...
// .wrangler/tmp/bundle-zQClsm/strip-cf-connecting-ip-header.js
...
async function testReasoning(request, env, corsHeaders) {
  ...
  console.log("\u{1F9E0} Testing Llama-4-Scout reasoning model...");
...
// .wrangler/tmp/bundle-zQClsm/middleware-insertion-facade.js
const __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
const middleware_insertion_facade_default = ai_test_default;
...
// .wrangler/tmp/bundle-zQClsm/middleware-loader.entry.ts
