...
import { seedProjectProgress } from './seed-project-progress';
import { seedMcpRoadmap } from './seed-mcp-roadmap';
...
export default async function seed() {
  ...
  // Seed current project progress
  await seedProjectProgress();

  // Seed MCP integration roadmap
  await seedMcpRoadmap();
